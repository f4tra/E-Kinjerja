...
$query_tgs_kreatif = "SELECT * FROM tugas_kreatif";
$tgs_kreatif = mysqli_query($koneksi,$query_tgs_kreatif ) or die(mysqli_error());
$row_tgs_kreatif = mysqli_fetch_assoc($tgs_kreatif);
$totalRows_tgs_kreatif = mysqli_num_rows($tgs_kreatif);
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" --><em>Tugas Kreatif</em><!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->Data Tugas Kreatif<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Data Tugas Kreatif <a onClick="return confirm('Tambah Data Baru?')" href="add_tgs_kreatif.php">
                                <button class="btn btn-success" style="float:right;"><i class="fa fa-plus-square"></i> Tambah</button>
                            ...
                            <thead>
							  ...
							  do { $no++?>
                                <tr>
                                  ...
                                  <td><?php echo $row_tgs_kreatif['id_tgs_kreatif']; ?></td>
                                  <?php 
                                  $dt_pgw = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM pegawai WHERE id_pegawai='".$row_tgs_kreatif['id_pegawai']."' "));
                                   ?>
                                  <td><?php echo $dt_pgw['nama']; ?></td>
                                  <td><?php echo $row_tgs_kreatif['keterangan']; ?></td>
                                  <td><?php echo $row_tgs_kreatif['file_upload']; ?></td>
                                  <td><?php echo $row_tgs_kreatif['tgl_input']; ?></td>
                                  <td><?php echo $row_tgs_kreatif['nilai']; ?></td>
                                  <td align="center">
                                  <a href="edit_tgs_kreatif.php?id_tgs_kreatif=<?php echo $row_tgs_kreatif['id_tgs_kreatif']; ?>">Edit</a> | <a href="hapus.php?id_tgs_kreatif=<?php echo $row_tgs_kreatif['id_tgs_kreatif']; ?>">Hapus</a></td>
                                </tr>
                                <?php } while ($row_tgs_kreatif = mysqli_fetch_assoc($tgs_kreatif)); ?>
                              </tbody>
                            </table>
                            </div>
...
<?php
mysqli_free_result($tgs_kreatif);
