...
$query_tgs_tambahan = "SELECT * FROM tugas_tambahan";
$tgs_tambahan = mysqli_query($koneksi,$query_tgs_tambahan ) or die(mysqli_error());
$row_tgs_tambahan = mysqli_fetch_assoc($tgs_tambahan);
$totalRows_tgs_tambahan = mysqli_num_rows($tgs_tambahan);
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" --><em>Data Tugas Tambahan</em><!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->Data Tugas Tambahan<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Data Semua Tugas Tambahan <a onClick="return confirm('Tambah Data?')" href="add_tgs_tambahan.php">
                                <button style="float: right;" class="btn btn-success"><i class="fa fa-plus-square"></i> Tambah</button>
                            ...
                            <table width="100%" class="table table-striped table-bordered" id="dataTables-example">
							  ...
							  do { $no++?>
                                <tr>
                                  ...
                                  <td><?php echo $row_tgs_tambahan['id_tgs_tambahan']; ?></td>
                                  <?php 
                                  $dt_pgw = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM pegawai WHERE id_pegawai='".$row_tgs_tambahan['id_pegawai']."' "));
                                   ?>
                                  <td><?php echo $dt_pgw['nama']; ?></td>
                                  <td><?php echo $row_tgs_tambahan['ket']; ?></td>
                                  <td><?php echo $row_tgs_tambahan['file_upload']; ?></td>
                                  <td><?php echo $row_tgs_tambahan['tgl']; ?></td>
                                  <td><?php echo $row_tgs_tambahan['nilai']; ?></td>
                                  <td align="center">
                                    <a href="edit_tgs_tambahan.php?id_tgs_tambahan=<?php echo $row_tgs_tambahan['id_tgs_tambahan'] ?>">Edit</a> | 
                                    <a href="hapus.php?id_tgs_tambahan=<?php echo $row_tgs_tambahan['id_tgs_tambahan'] ?>">Hapus</a>
                                   </td>
                                </tr>
                                <?php } while ($row_tgs_tambahan = mysqli_fetch_assoc($tgs_tambahan)); ?>
                                </tbody>
                            </table>
                        </div>
...
<?php
mysqli_free_result($tgs_tambahan);
