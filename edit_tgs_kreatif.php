...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE tugas_kreatif SET id_pegawai=%s, keterangan=%s, tgl_input=%s, nilai=%s WHERE id_tgs_kreatif=%s",
                       GetSQLValueString($_POST['id_pegawai'], "text"),
                       GetSQLValueString($_POST['keterangan'], "text"),
                       
                       GetSQLValueString($tgl_hasil, "date"),
                       GetSQLValueString($_POST['nilai'], "text"),
                       GetSQLValueString($_POST['id_tgs_kreatif'], "text"));
		} else {
		$updateSQL = sprintf("UPDATE tugas_kreatif SET id_pegawai=%s, keterangan=%s, file_upload=%s, tgl_input=%s, nilai=%s WHERE id_tgs_kreatif=%s",
                       GetSQLValueString($_POST['id_pegawai'], "text"),
                       GetSQLValueString($_POST['keterangan'], "text"),
  ...
  mysqli_query("INSERT INTO history(nama,ket,tgl)VALUES('$nama_perubah','Merubah Data Tugas Kreatif','$tgl_rubah')");

// ------------------ History ------------------

  $updateGoTo = "dt_tgs_kreatif.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_edit_tgs_kreatif = "-1";
if (isset($_GET['id_tgs_kreatif'])) {
  $colname_edit_tgs_kreatif = $_GET['id_tgs_kreatif'];
}
// mysqli_select_db($database_koneksi, $koneksi);
$query_edit_tgs_kreatif = sprintf("SELECT * FROM tugas_kreatif WHERE id_tgs_kreatif = %s", GetSQLValueString($colname_edit_tgs_kreatif, "text"));
$edit_tgs_kreatif = mysqli_query($koneksi,$query_edit_tgs_kreatif ) or die(mysqli_error());
$row_edit_tgs_kreatif = mysqli_fetch_assoc($edit_tgs_kreatif);
$totalRows_edit_tgs_kreatif = mysqli_num_rows($edit_tgs_kreatif);
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" -->Edit Tugas Kreatif<!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->Edit Tugas Kreatif Pegawai<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Halaman Edit Tugas Kreatif Pegawai <a href="dt_tgs_kreatif.php"><button class="btn btn-outline btn-danger"><i class="fa fa-reply fa-sw"></i> Kembali</button> </a><!-- InstanceEndEditable --></div>
                            <!-- /.panel-heading -->
                            ...
                            <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1">
                              <table width="100%" align="center">
                                <tr valign="baseline">
                                  ...
                                  <td><input type="text" readonly class="form-control" name="id_pegawai" value="<?php echo htmlentities($row_edit_tgs_kreatif['id_pegawai'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td nowrap align="left" valign="top">KETERANGAN TUGAS</td>
                                  <td valign="top">:</td>
                                  <td valign="top"><textarea class="form-control" name="keterangan" rows="2"><?php echo htmlentities($row_edit_tgs_kreatif['keterangan'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>FILE UPLOAD</td>
                                  <td valign="middle">:</td>
                                  <td valign="middle"><label for="file_upload"></label>
                                ...
                                <tr valign="baseline">
                                  ...
                                  <td valign="middle">:</td>
                                  <?php
                                  $pecah_tgl=explode("-",$row_edit_tgs_kreatif['tgl_input']);
									$thn=$pecah_tgl[0];
									$bln=$pecah_tgl[1];
									$tgl=$pecah_tgl[2];
									$tgl_input_tk= $tgl.'/'.$bln.'/'.$thn;
								  ?>
                                  <td><input class="form-control" type="text" id="tgl1" name="tgl_input" value="<?php echo $tgl_input_tk; ?>" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>NILAI</td>
                                  <td valign="middle">:</td>
                                  <td><input class="form-control" type="number" name="nilai" value="<?php echo htmlentities($row_edit_tgs_kreatif['nilai'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                              ...
                              <input type="hidden" name="id_tgs_kreatif" value="<?php echo $row_edit_tgs_kreatif['id_tgs_kreatif']; ?>">
                            </form>
                            <p>&nbsp;</p>
...
<?php
mysqli_free_result($edit_tgs_kreatif);
