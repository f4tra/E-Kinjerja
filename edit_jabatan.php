...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE jabatan SET nm_jabatan=%s WHERE id_jabatan=%s",
                       GetSQLValueString($_POST['nm_jabatan'], "text"),
                       GetSQLValueString($_POST['id_jabatan'], "int"));
  ...
  mysqli_query($koneksi,"INSERT INTO history(nama,ket,tgl)VALUES('$nama_perubah','Merubah Data Jabatan ','$tgl_rubah')");

// ------------------ History ------------------

  $updateGoTo = "dt_jabatan.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['id_jabatan'])) {
  $colname_jabatan = $_GET['id_jabatan'];
}
// mysqli_select_db($database_koneksi, $koneksi);
$query_jabatan = sprintf("SELECT * FROM jabatan WHERE id_jabatan = %s", GetSQLValueString($colname_jabatan, "int"));
$jabatan = mysqli_query($koneksi,$query_jabatan ) or die(mysqli_error());
$row_jabatan = mysqli_fetch_assoc($jabatan);
$totalRows_jabatan = mysqli_num_rows($jabatan);
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" -->Edit Jabatan<!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->Edit Data Jabatan<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Edit Data Jabatan <a href="dt_jabatan.php">
                            ...
                            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                              <table width="100%" align="center">
                                <tr valign="baseline">
                                  <td width="13%" align="left" valign="middle" nowrap>ID JABATAN</td>
                                  <td width="1%" valign="middle">:</td>
                                  <td><input type="text" class="form-control col-3" disabled value="<?php echo $row_jabatan['id_jabatan']; ?>"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>NAMA JABATAN</td>
                                  <td valign="middle">:</td>
                                  <td><input type="text" class="form-control" name="nm_jabatan" value="<?php echo htmlentities($row_jabatan['nm_jabatan'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td nowrap align="right">&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td><button class="btn btn-primary"><i class="fa fa-save fa-sw"></i> Simpan</button></td>
                                </tr>
                              </table>
                              <input type="hidden" name="MM_update" value="form1">
                              <input type="hidden" name="id_jabatan" value="<?php echo $row_jabatan['id_jabatan']; ?>">
                            </form>
                            <p>&nbsp;</p>
