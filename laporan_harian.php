	...
	?>
      ...
      <?php } ?>  
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" --><i class="fa fa-folder-open-o"></i> LAPORAN HARIAN<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->TUGAS KREATIF<!-- InstanceEndEditable --></div>
                            <!-- /.panel-heading -->
                            <div class="panel-body"><!-- InstanceBeginEditable name="Konten" -->
                            
                          
				<form accept="" method="post" target="_blank">
                <h3 align="center" style="color: #000;">CETAK LAPORAN<br> DATA TUGAS KREATIF</h3><hr>
	<!-- =================  Form Pencarian ================= -->
				<table> 
                 <tr>
                 	<td></td>
                            ...
                            if($jml > 0){
                                echo"
                                 ...
                                 while($pegawai=mysqli_fetch_array($tampil)){
                                     $code = "id_pegawai='".$pegawai['id_pegawai']."'";
                                     // echo "<option value=and".$code.">$pegawai[nama]  --  Unit Kerja: $pegawai[unit_kerja]</option>";?>
                                     <option value="and id_pegawai='<?php echo $pegawai['id_pegawai']?>' "><?php echo $pegawai['nama'] ?> -- Unit Kerja: <?php echo $pegawai['unit_kerja'] ?></option>
                   ...
                   <td></td>
					<td>
                    TANGGAL
						<input type="text" name="tgl1" required class="form-control" id="tgl1" >
				   </td>
                  </tr>
                  <tr>
					<td>&nbsp;</td>
                    ...
                    <td></td>
				    <td align="right">
                       <button class="btn btn-outline btn-primary" onclick="this.form.action='lap/lap_harian_tk.php'" name="cariiklan" ><i class="fa fa-print fa-sw"></i> Cetak</button>
                    </td>
...
<!-- InstanceEndEditable --></div>
				...
				<div class="col-lg-6">
                    <div class="panel panel-default">
                        <div style="font-size: 11px;" class="panel-heading"> 
                            <i class="fa fa-print fa-fw"></i>TUGAS TAMBAHAN
                        </div>
                        <div class="panel-body">
                          <h3 align="center" style="color: #000;">CETAK LAPORAN<br> DATA TUGAS TAMBAHAN</h3><hr>
	<!-- =================  Form Pencarian ================= -->
				<form accept="" method="post" target="_blank">
				<table> 
                 <tr>
                   ...
                   <td></td>
					<td>
                    TANGGAL
						<input type="text" name="tgl2" required class="form-control" id="tgl2" >
				   </td>
                  </tr>
                  <tr>
					<td>&nbsp;</td>
					...
					<td></td>
                    <td></td>
				    <td align="right"><input class="btn btn-primary" style="cursor: pointer;" onclick="this.form.action='lap/lap_harian_tt.php'" type="submit" name="cariiklan" value="Cetak"/></td>
