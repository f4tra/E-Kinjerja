...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO tugas_kreatif (id_tgs_kreatif, id_pegawai, keterangan, file_upload, tgl_input, nilai) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  mysqli_query($koneksi,"INSERT INTO history(nama,ket,tgl)VALUES('$nama_perubah','Menambahkan Data Tugas Kreatif Baru','$tgl_rubah')");

// ------------------ History ------------------

  $insertGoTo = "dt_tgs_kreatif.php";
  if (isset($_SERVER['QUERY_STRING'])) {
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" --><em>Tambah Tugas Kreatif</em><!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->Tambah Data Tugas Kreatif<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Tugas Kreatif <a href="dt_tgs_kreatif.php">
                                <button class="btn btn-outline btn-danger"><i class="fa fa-reply fa-fw"></i>Kembali</button>
                                </a><!-- InstanceEndEditable --></div>
                            <!-- /.panel-heading -->
                            <div class="panel-body"><!-- InstanceBeginEditable name="Konten" -->
                            <?php 
                              $carikode = mysqli_query($koneksi,"SELECT max(id_tgs_kreatif) from tugas_kreatif") or die (mysqli_error());
                              $datakode = mysqli_fetch_array($carikode);
                              if($datakode) {
                                $nilaikode = substr($datakode[0], 3);
                                $kode = (int) $nilaikode;
                                $kode = $kode + 1;
                                $hasilkode = "TGK".str_pad($kode, 4, "0", STR_PAD_LEFT);
                              } else {
                                $hasilkode = "TGK0001";
                              }       
                            ?>
                            <form method="post" name="form1" action="<?php echo $editFormAction; ?>" enctype="multipart/form-data">
                              <table width="100%" align="center">
                                <tr valign="baseline">
                                  <td width="11%" align="left" valign="middle" nowrap>ID TUGAS KREATIF</td>
                                  <td width="1%" valign="middle">:</td>
                                  <td width="89%"><input class="form-control col-3" readonly type="text" name="id_tgs_kreatif" value="<?php echo $hasilkode ?>"></td>
                                </tr>
                                <tr valign="baseline">
                                ...
                                <tr valign="baseline">
                                  <td nowrap align="left" valign="top">KETERANGAN</td>
                                  <td valign="top">:</td>
                                  <td><textarea required name="keterangan" class="form-control" cols="50" rows="5"></textarea></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>FILE UPLOAD</td>
                                  <td valign="middle">:</td>
                                  <td><input required type="file" class="form-control" name="file_upload" value="" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>TANGGAL</td>
                                  <td valign="middle">:</td>
                                  <td><input required type="text" id="tgl1" class="form-control" name="tgl_input" value="" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>NILAI</td>
                                  <td valign="middle">:</td>
                                  <td><input required type="text" class="form-control" name="nilai" value="" size="32"></td>
                                </tr>
                                <tr valign="baseline">
