...
$query_data_diri = "SELECT * FROM data_diri";
$data_diri = mysqli_query($koneksi,$query_data_diri) or die (mysqli_error());
$row_data_diri = mysqli_fetch_assoc($data_diri);
$totalRows_data_diri = mysqli_num_rows($data_diri);
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" -->Data CV Pegawai<!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->Data CV Semua Pegawai<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Data CV Pekerja Honorer Diskominfo Barito Kuala <a  style="float: right;" href="add_cv.php"><button class="btn btn-success"><i class="fa fa-plus-square"></i> Tambah</button></a><!-- InstanceEndEditable --></div>
                            <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-hover table-bordered" id="dataTables-example">
                              ...
                              <?php do { ?>
                                <tr>
                                  <td>
                                  <a href="edit_cv.php?id_data_diri=<?php echo $row_data_diri['id_data_diri']; ?>">Edit</a> |
                                  <a onClick="return confirm('Hapus Data?')" href="hapus.php?id_data_diri=<?php echo $row_data_diri['id_data_diri']; ?>">Hapus</a></td>
                                  <td><?php echo $row_data_diri['id_data_diri']; ?></td>
                                  <td><?php echo $row_data_diri['id_pegawai']; ?></td>
                                  <td><?php echo $row_data_diri['tempat_lahir']; ?>, <?php echo $row_data_diri['tgl_lahir']; ?></td>
                                  <td><?php echo $row_data_diri['alamat_ktp']; ?></td>
                                  <td><?php echo $row_data_diri['no_ktp']; ?> / <?php echo $row_data_diri['no_kk']; ?></td>
                                  <td><?php echo $row_data_diri['sd_thn']; ?></td>
                                  <td><?php echo $row_data_diri['smp_thn']; ?></td>
                                  <td><?php echo $row_data_diri['sma_thn']; ?></td>
                                  <td><?php echo $row_data_diri['univ_thn']; ?></td>
                                  <td><?php echo $row_data_diri['jurusan']; ?></td>
                                  <td><?php echo $row_data_diri['kampus']; ?></td>
                                  <td><?php echo $row_data_diri['hoby']; ?></td>
                                  <td><?php echo $row_data_diri['no_tlp']; ?></td>
                                  <td><a target="_blank" href="upload/pas_foto/<?php echo $row_data_diri['pas_foto']; ?>">Lihat</a>
                                  </td>
                                </tr>
                                <?php } while ($row_data_diri = mysqli_fetch_assoc($data_diri)); ?>
                                </tbody>
                            </table>
                            </div>
