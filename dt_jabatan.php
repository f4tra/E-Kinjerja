...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO jabatan (nm_jabatan) VALUES (%s)",
  ...
  mysqli_query($koneksi,"INSERT INTO history(nama,ket,tgl)VALUES('$nama_perubah','Menambahkan Data Jabatan Baru','$tgl_rubah')");

// ------------------ History ------------------

  $insertGoTo = "dt_jabatan.php";
  if (isset($_SERVER['QUERY_STRING'])) {
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" --><em>Beranda</em><!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->Data Jabatan<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Data Jabatan<!-- InstanceEndEditable --></div>
                            <!-- /.panel-heading -->
                            <div class="panel-body"><!-- InstanceBeginEditable name="Konten" -->
                            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                              <table width="100%" align="center">
                                <tr valign="baseline">
                                  <td width="11%" align="right" valign="middle" nowrap>NAMA JABATAN</td>
                                  <td width="1%" valign="middle">:</td>
                                  <td width="89%"><input class="form-control" type="text" required name="nm_jabatan" value="" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                            ...
                            <table class="table table-striped table-bordered table-hover " id="dataTables-example">
                              ...
                              <tr>
                                ...
                                <td align="center" width="14%">ID JABATAN</td>
                                <th>NAMA JABATAN</th>
                              ...
                              do { $no++?>
                                <tr>
                                  ...
                                  <td align="center"><?php echo $row_jabatan['id_jabatan']; ?></td>
                                  <td><?php echo $row_jabatan['nm_jabatan']; ?></td>
                                  <td align="center"><a onClick="return confirm('Edit Data?')" href="edit_jabatan.php?id_jabatan=<?php echo $row_jabatan['id_jabatan']; ?>">Edit</a> | <a onClick="return confirm('Hapus Data?')" href="hapus.php?id_jabatan=<?php echo $row_jabatan['id_jabatan']; ?>">Hapus</a></td>
                                </tr>
                                <?php } while ($row_jabatan = mysqli_fetch_assoc($jabatan)); ?>
                                </tbody>
                            </table>
                            </div>
