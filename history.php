...
$query_history = "SELECT * FROM history order by id_history DESC";
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" -->History<!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->History<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Data History eKinerja<!-- InstanceEndEditable --></div>
                            <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table">
							  ...
							  do { $no++?>
                                <tr>
                                  ...
                                  <td><?php echo $row_history['tgl']; ?></td>
                                  <?php if(@$_SESSION['Admin']){ ?>
                                  <td><a href="hapus.php?id_history=<?php echo $row_history['id_history']; ?>">Hapus</a></td>
                                  <?php } else {?>
                                  <td></td>
                                  <?php } ?>
                                </tr>
