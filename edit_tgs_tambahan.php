...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE tugas_tambahan SET id_pegawai=%s, ket=%s, tgl=%s, nilai=%s WHERE id_tgs_tambahan=%s",
			...
			$updateSQL = sprintf("UPDATE tugas_tambahan SET id_pegawai=%s, ket=%s, file_upload=%s, tgl=%s, nilai=%s WHERE id_tgs_tambahan=%s",
                       GetSQLValueString($_POST['id_pegawai'], "text"),
                       GetSQLValueString($_POST['ket'], "text"),
  ...
  mysqli_query($koneksi,"INSERT INTO history(nama,ket,tgl)VALUES('$nama_perubah','Merubah Data Tugas Tambahan','$tgl_rubah')");

// ------------------ History ------------------

  $updateGoTo = "dt_tugas_tambahan.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_edit_tgs_tambahan = "-1";
if (isset($_GET['id_tgs_tambahan'])) {
  $colname_edit_tgs_tambahan = $_GET['id_tgs_tambahan'];
}
// mysqli_select_db($database_koneksi, $koneksi);
$query_edit_tgs_tambahan = sprintf("SELECT * FROM tugas_tambahan WHERE id_tgs_tambahan = %s", GetSQLValueString($colname_edit_tgs_tambahan, "text"));
$edit_tgs_tambahan = mysqli_query($koneksi,$query_edit_tgs_tambahan ) or die(mysqli_error());
$row_edit_tgs_tambahan = mysqli_fetch_assoc($edit_tgs_tambahan);
$totalRows_edit_tgs_tambahan = mysqli_num_rows($edit_tgs_tambahan);
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" -->Edit Tugas Tambahan<!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->Edit Tugas Tambahan<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Halaman Edit Tugas Tambahan Pegawai <a href="dt_tugas_tambahan.php"><button class="btn btn-outline btn-danger"><i class="fa fa-reply fa-sw"></i> Kembali</button></a><!-- InstanceEndEditable --></div>
                            <!-- /.panel-heading -->
                            ...
                            <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1">
                              <table width="100%" align="center">
                                <tr valign="baseline">
                                  ...
                                  <td><input class="form-control" name="id_pegawai" type="text" value="<?php echo htmlentities($row_edit_tgs_tambahan['id_pegawai'], ENT_COMPAT, 'utf-8'); ?>" size="32" readonly></td>
                                </tr>
                                <tr valign="baseline">
                                  <td nowrap align="left" valign="top">KETERANGAN TUGAS</td>
                                  <td valign="top">:</td>
                                  <td valign="top"><textarea class="form-control" name="ket" rows="2"><?php echo htmlentities($row_edit_tgs_tambahan['ket'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
                                </tr>
                                <tr valign="baseline">
                                ...
                                <tr valign="baseline">
                                  ...
                                  <td valign="middle">:</td>
                                  <?php
                                  $pecah_tgl=explode("-",$row_edit_tgs_tambahan['tgl']);
									$thn=$pecah_tgl[0];
									$bln=$pecah_tgl[1];
									$tgl=$pecah_tgl[2];
									$tgl_input_tt= $tgl.'/'.$bln.'/'.$thn;
								  ?>
                                  <td valign="middle"><input class="form-control" type="text" id="tgl1" name="tgl" value="<?php echo $tgl_input_tt; ?>" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>NILAI</td>
                                  <td valign="middle">:</td>
                                  <td valign="middle"><input class="form-control" type="number" name="nilai" value="<?php echo htmlentities($row_edit_tgs_tambahan['nilai'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                              ...
                              <input type="hidden" name="id_tgs_tambahan" value="<?php echo $row_edit_tgs_tambahan['id_tgs_tambahan']; ?>">
                            </form>
                            <p>&nbsp;</p>
...
<?php
mysqli_free_result($edit_tgs_tambahan);
