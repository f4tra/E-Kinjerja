	...
	?>
      ...
      <?php } ?>  
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->E-Kinerja Honorer (Penilaian Kinerja Tenaga Honorer)<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Selamat Datang di Aplikasi e-Kinerja Honorer Diskominfo Kab. Batola<!-- InstanceEndEditable --></div>
                            <!-- /.panel-heading -->
						...
						<div class="col-lg-4">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <?php 
												$no=0;
                                                $sql=mysqli_query($koneksi,"SELECT * FROM history order by id_history DESC LIMIT 0, 10");
