...
<?php
  ...
  $sql_login = mysql_query("SELECT * from login where id_login = '$loginer'") or die (mysql_error());
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="../index.php">eKinerja</a> / <i style="color: black;"><!-- TemplateBeginEditable name="Location" -->Beranda<!-- TemplateEndEditable --></i></em>
                <li class="dropdown"> 
                    ...
                    <ul class="dropdown-menu dropdown-messages" style="font-size: 11px;">
                        <?php 
                        $sql_history = mysql_query("SELECT * FROM history order by id_history DESC LIMIT 0, 5");
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- TemplateBeginEditable name="judul" -->E-Kinerja Honorer <!-- TemplateEndEditable --></h4>
                ...
                <div class="row">   
                    <!-- /.col-lg-8 --><!-- TemplateBeginEditable name="seting" -->
                    <div class="col-lg-12">
					<!-- TemplateEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- TemplateBeginEditable name="Sub Judul" -->Selamat Datang di Aplikasi e-Kinerja Honorer Diskominfo Kabuppaten BATOLA<!-- TemplateEndEditable --></div>
                            <!-- /.panel-heading -->
                            <div class="panel-body"><!-- TemplateBeginEditable name="Konten" --><img width="100%" src="../img/bg.jpg"><!-- TemplateEndEditable --></div>
                        </div>
                    </div>
