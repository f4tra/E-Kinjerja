...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE pegawai SET  id_jabatan=%s, status=%s, nik=%s, nama=%s, jk=%s, unit_kerja=%s, bidang=%s WHERE id_pegawai=%s",
                       GetSQLValueString($_POST['id_jabatan'], "text"),
                       GetSQLValueString($_POST['status'], "text"),
                       GetSQLValueString($_POST['nik'], "text"),
                       GetSQLValueString($_POST['nama'], "text"),
                       GetSQLValueString($_POST['jk'], "text"),
                       GetSQLValueString($_POST['unit_kerja'], "text"),
                       GetSQLValueString($_POST['bidang'], "text"),
...
// ------------------ History ------------------
  ...
  mysqli_query($koneksi,"INSERT INTO history(nama,ket,tgl)VALUES('$nama_perubah','Merubah Data Pegawai','$tgl_rubah')");

// ------------------ History ------------------

  $updateGoTo = "dt_pegawai.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['id_pegawai'])) {
  $colname_pegawai = $_GET['id_pegawai'];
}
// mysqli_select_db($database_koneksi, $koneksi);
$query_pegawai = sprintf("SELECT * FROM pegawai WHERE id_pegawai = %s", GetSQLValueString($colname_pegawai, "text"));
$pegawai = mysqli_query($koneksi,$query_pegawai ) or die(mysqli_error());
$row_pegawai = mysqli_fetch_assoc($pegawai);
$totalRows_pegawai = mysqli_num_rows($pegawai);
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" --><em>Edit Data Pegawi</em><!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->Edit Data Pegawai<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Halaman Edit Data Pegawaii <a href="dt_pegawai.php"><button class="btn btn-outline btn-danger"><i class="fa fa-reply"></i> Kembali</button></a><!-- InstanceEndEditable --></div>
                            <!-- /.panel-heading -->
                            <div class="panel-body"><!-- InstanceBeginEditable name="Konten" -->
                            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                              <table width="100%" align="center">
                                <tr valign="baseline">
                                  <td height="25" width="15%" align="left" nowrap>ID PEGAWAI</td>
                                  <td width="1%">:</td>
                                  <td width="80%"><?php echo $row_pegawai['id_pegawai']; ?></td>
                                </tr>
                                
                                <tr valign="middle">
                                  <td nowrap align="left">ID JABATAN</td>
                                  <td>:</td>
                                  <td>
                                  ...
                                  <?php
                                         ...
                                         while ($data=mysqli_fetch_array($sql)) {
                                          if ($row_pegawai['id_jabatan']==$data['id_jabatan']) {
                                           $select="selected";
                                          }else{
                                           $select="";
                                          }
                                          echo "<option $select value=$data[id_jabatan]>".$data['nm_jabatan']."</option>";
                                         }
                                        ?>      
                                    </select>
                                   </td>
                                ...
                                <tr valign="middle">
                                  <td nowrap align="left">N I K</td>
                                  <td>:</td>
                                  <td><input type="text" class="form-control" name="nik" value="<?php echo htmlentities($row_pegawai['nik'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                                </tr>
                                <tr valign="middle">
                                  <td nowrap align="left">NAMA LENGKAP</td>
                                  <td>:</td>
                                  <td><input type="text" class="form-control" name="nama" value="<?php echo htmlentities($row_pegawai['nama'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                                </tr>
                                <tr valign="middle">
                                  <td nowrap align="left">JENIS KELAMIN</td>
                                  <td>:</td>
                                  <td><select class="form-control" name="jk">
                                    <option value="" >Pilih</option>
                                    <option value="L" <?php if (!(strcmp("L", htmlentities($row_pegawai['jk'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Laki-laki</option>
                                    <option value="P" <?php if (!(strcmp("P", htmlentities($row_pegawai['jk'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Perempuan</option>
                                  </select></td>
                                </tr>
                                <tr valign="middle">
                                  ...
                                  <td><select class="form-control" name="status">
                                    <option value="" >Pilih</option>
                                    <option value="Menikah" <?php if (!(strcmp("Menikah", htmlentities($row_pegawai['status'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Menikah</option>
                                    <option value="Belum Menikah" <?php if (!(strcmp("Belum Menikah", htmlentities($row_pegawai['status'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Belum Menikah</option>
                                  </select></td>
                                </tr>
                                <tr valign="middle">
                                  <td nowrap align="left">UNIT KERJA</td>
                                  <td>:</td>
                                  <td><input type="text" class="form-control" name="unit_kerja" value="<?php echo htmlentities($row_pegawai['unit_kerja'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                                </tr>
                                <tr valign="middle">
                                  <td nowrap align="left">BIDANG</td>
                                  <td>:</td>
                                  <td><input type="text" class="form-control" name="bidang" value="<?php echo htmlentities($row_pegawai['bidang'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                                </tr>
                                <tr valign="middle">
                              ...
                              <input type="hidden" name="id_pegawai" value="<?php echo $row_pegawai['id_pegawai']; ?>">
                            </form>
                            <p>&nbsp;</p>
