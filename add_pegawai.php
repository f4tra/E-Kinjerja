...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO pegawai (id_pegawai, id_jabatan, status, nik, nama, jk, unit_kerja, bidang) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  mysqli_query($koneksi,"INSERT INTO history(nama,ket,tgl)VALUES('$nama_perubah','Menambahkan Data Pegawai Baru','$tgl_rubah')");

// ------------------ History ------------------

  $insertGoTo = "dt_pegawai.php";
  if (isset($_SERVER['QUERY_STRING'])) {
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" --><em>Tambah Data Pegawai</em><!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->Tambah Data Pegawai<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Tambah Data Pegawai
                                <a href="dt_pegawai.php"> <button class="btn btn-outline btn-danger"><i class="fa fa-reply fa-fw"></i> Kembali</button></a>
                                <!-- InstanceEndEditable --></div>
                            <!-- /.panel-heading -->
                            <div class="panel-body"><!-- InstanceBeginEditable name="Konten" -->
                            <?php 
                              $carikode = mysqli_query($koneksi,"SELECT max(id_pegawai) from pegawai") or die (mysqli_error());
                              $datakode = mysqli_fetch_array($carikode);
                              if($datakode) {
                                $nilaikode = substr($datakode[0], 3);
                                $kode = (int) $nilaikode;
                                $kode = $kode + 1;
                                $hasilkode = "PGW".str_pad($kode, 3, "0", STR_PAD_LEFT);
                              } else {
                                $hasilkode = "PGW001";
                              }       
                            ?>
                            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                              <table width="100%" align="center">
                                <tr valign="baseline">
                                  <td width="15%" align="left" valign="middle" nowrap>PEGAWAI:</td>
                                  <td width="1%" valign="middle">:</td>
                                  <td width="83%"><input name="id_pegawai" type="text" readonly=""  class="form-control" value="<?php echo $hasilkode ?>"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>N I K</td>
                                  <td valign="middle">:</td>
                                  <td><input type="text" name="nik" required value="" class="form-control"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>NAMA</td>
                                  <td valign="middle">:</td>
                                  <td><input type="text" name="nama" required value="" class="form-control"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>JENIS KELAMIN</td>
                                  <td valign="middle">:</td>
                                  <td>
                                ...
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>JABATAN</td>
                                  <td valign="middle">:</td>
                                  <td>
                                    ...
                                    if($jml > 0){
                                        ...
                                        <option value='' selected>-- Pilih --</option>";
                                         while($pgw=mysqli_fetch_array($tampil)){
                                             echo "<option value=$pgw[id_jabatan]>$pgw[nm_jabatan]</option>";
                                         }
                                    }
                                    ?>
                                    </select>
                                ...
                                <tr valign="baseline">
                                  <td align="left" valign="middle" required nowrap>UNIT KERJA</td>
                                  <td valign="middle">:</td>
                                  <td><input type="text" name="unit_kerja" required value="" class="form-control"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" required nowrap>BIDANG</td>
                                  <td valign="middle">:</td>
                                  <td><input type="text" name="bidang" value="" class="form-control col6"></td>
                                </tr>
                                <tr valign="baseline">
