...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO login (id_login, nik, nama, username, password, hak_akses) VALUES (%s, %s, %s, %s, %s, %s)",
...
$login = mysqli_query($koneksi,$query_login) or die(mysqli_error());
	...
	?>
      ...
      <?php } ?>  
            ...
            <ul class="nav navbar-top-links navbar-right">
                <em><a href="index.php">eKinerja</a> / <i style="color: black;"><!-- InstanceBeginEditable name="Location" --><em>Hak Akses</em><!-- InstanceEndEditable --></i></em>
                <li class="dropdown"> 
        ...
        <div id="page-wrapper"> 
                ...
                <div class="row">
                    <div class="col-lg-12"> 
                        <h4 class="page-header"><!-- InstanceBeginEditable name="judul" -->Hak Akses<!-- InstanceEndEditable --></h4>
					...
					<!-- InstanceEndEditable -->
                        ...
                        <div class="panel panel-default">
                            <div style="font-size: 11px;" class="panel-heading"> 
                                <i class="fa fa-table fa-fw"></i><!-- InstanceBeginEditable name="Sub Judul" -->Data Hak Akses eKiinerja Diskominfo Kab. Batola<!-- InstanceEndEditable --></div>
                            <!-- /.panel-heading -->
                            <div class="panel-body"><!-- InstanceBeginEditable name="Konten" -->
                              <?php 
                              $carikode = mysqli_query($koneksi,"SELECT max(id_login) from login") or die (mysqli_error());
                              $datakode = mysqli_fetch_array($carikode);
                              if($datakode) {
                                $nilaikode = substr($datakode[0], 2);
                                $kode = (int) $nilaikode;
                                $kode = $kode + 1;
                                $hasilkode = "LG".str_pad($kode, 2, "0", STR_PAD_LEFT);
                              } else {
                                $hasilkode = "LG01";
                              }       
                            ?>
                            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                              <table width="100%" align="center">
                                <tr valign="baseline">
                                  <td width="11%" align="left" valign="middle" nowrap>ID LOGIN</td>
                                  <td width="1%" valign="middle">:</td>
                                  <td width="87%"><input name="id_login" type="text" readonly="" class="form-control" value="<?php echo $hasilkode ?>" ></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>N I K / N I P</td>
                                  <td valign="middle">:</td>
                                  <td><input type="text" name="nik" required autofocus="" class="form-control" value="" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>N A M A</td>
                                  <td valign="middle">:</td>
                                  <td><input type="text" name="nama" required class="form-control" value="" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>USERNAME</td>
                                  <td valign="middle">:</td>
                                  <td><input type="text" name="username" required class="form-control" value="" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>PASSWORD</td>
                                  <td valign="middle">:</td>
                                  <td><input type="text" name="password" required class="form-control" value="" size="32"></td>
                                </tr>
                                <tr valign="baseline">
                                  <td align="left" valign="middle" nowrap>HAK AKSES</td>
                                  <td valign="middle">:</td>
                                  <td><select class="form-control" required name="hak_akses">
                                    <option value="" >Pilih</option>
                                    <option value="Admin" <?php if (!(strcmp("Admin", ""))) {echo "SELECTED";} ?>>Admin</option>
                                    <option value="Pimpinan" <?php if (!(strcmp("Pimpinan", ""))) {echo "SELECTED";} ?>>Pimpinan</option>
                                    <option value="Pegawai" <?php if (!(strcmp("Pegawai", ""))) {echo "SELECTED";} ?>>Pegawai</option>
                                  </select></td>
                                </tr>
                                <tr valign="baseline">
                                  <td nowrap align="right">&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td><button class="btn btn-primary"><i class="fa fa-plus-square fa-fw"></i> Tambahkan</button></td>
                                </tr>
                              </table>
                            ...
                            <thead>
                              ...
                              do { $no++?>
                                <tr align="center">
                                  ...
                                  <td><?php echo $row_login['id_login']; ?></td>
                                  <td><?php echo $row_login['nik']; ?></td>
                                  <td><?php echo $row_login['nama']; ?></td>
                                  <td><?php echo $row_login['username']; ?></td>
                                  <td>********</td>
                                  <td><?php echo $row_login['hak_akses']; ?></td>
                                  <td>
                                    <a href="edit_hak_akses.php?id_login=<?php echo $row_login['id_login']; ?>">Edit</a>
                                   | <a onClick="return confirm('Hapus Data ?')" href="hapus.php?id_login=<?php echo $row_login['id_login']; ?>">Hapus</a></td>
                                </tr>
                                <?php } while ($row_login = mysqli_fetch_assoc($login)); ?>
                              </tbody>
                            </table>
                            </div>
